const fs = require("fs");
const PushaError = require("./Error.js");
...
class PushaDatabase {
    ...
    set(key, value) {
        if (!key || typeof key !== "string") {
            throw new PushaError("Hatalı anahtar girildi!");
        }
        if (!value || value === undefined || value === null) {
            throw new PushaError("Hatalı veri girildi!");
        }
    ...
    has(key) {
        if(!key || typeof key !== "string") {
            throw new PushaError("Hatalı anahtar kullanımı!");
        }
    ...
    add(key, amount) {
        ...
        if (!amount || typeof amount !== "number") {
            throw new PushaError("Hatalı miktar girildi!");
        }
        const data = get(this.#file, key) || 0;
        if (isNaN(data)) {
            throw new PushaError("Girilen anahtar verisi sayı değil!")
        } 
    ...
    push(key, value) {
        ...
        if (value !== 0 && !value && typeof value !== "boolean") {
            throw new PushaError("Hatalı değer girildi!");
        }
        const data = this.get(key);
        if (!data) {
            this.set(key, [value]);
        ...
        if (!Array.isArray(data)) {
            throw new PushaError("Girilen anahtar verisi array değil!");
    ...
    backup(newFileName) {
        if (!newFileName || typeof newFileName !== "string") {
            throw new PushaError("Hatalı dosya ismi girildi girildi!");
        }
